...
const itemsStaff = [
  ...
  getItem(
    <NavLink to={`/dashboard/HistoryRentDriver`}>HistoryRentDriver</NavLink>,
    "HistoryRentDriver",
    <PieChartOutlined />
  ),
  getItem(
  ...
  getItem(
    <NavLink to={`/dashboard/fixedCosts`}>fixedCosts</NavLink>,
    "92ưew",
    <FileOutlined />
  ),
  getItem(
  ...
  getItem(
    <NavLink to={`/dashboard/typeOfDriver`}>TypeOfDriver</NavLink>,
    "TypeOfDriver",
    <FileOutlined />
  ),
  getItem(
    <NavLink to={`/dashboard/listVehicleRent`}>listVehicleRent</NavLink>,
    "listVehicleRent",
    <FileOutlined />
  ),
];
    ...
    <div>
      <Header>
        <div className="flex justify-between">
          <p className="text-white"> Admin System</p>
          <div className="text-black">
            <div className="relative">
              ...
              <div
                ...
                className={`absolute right-0 mt-4 flex w-[220px] pt-5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
